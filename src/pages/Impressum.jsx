...
function Impressum() {
  return (
    <div className="article-impressum">
      <h2>impressum</h2>
      <div className="info-article main-container">
        <p>Lennart Erschler</p>
        <p>Rosa-Aschenbrennnerbogen 9</p>
        <p>80797 München</p>
        <p>e-mail: kunst-lennart@gmx.de</p>
        <p>www.kunst-lennart.com</p>
      </div>

      
      <div className="text-article main-container">
